...
unitree_rl_init_state = RobotInitState(
        pos=[0.0, 0.0, 0.8],  # x,y,z [m]
        rot=[0.0, 0.0, 0.0, 1.0],  # x,y,z,w [quat]
        lin_vel=[0.0, 0.0, 0.0],  # x,y,z [m/s]
        ang_vel=[0.0, 0.0, 0.0],  # x,y,z [rad/s]
...
unitree_rl_init_state_dict = dataclasses.asdict(unitree_rl_init_state)

g1_23dof_dict.update({"init_state": unitree_rl_init_state_dict})
...
unitree_rl_init_state_dict.update({
    "walk_joint_angles": walk_joint_angles
})


g1_23dof_dict.update({"init_state": unitree_rl_init_state_dict})
g1_23dof_ext = RobotConfig(**g1_23dof_dict)

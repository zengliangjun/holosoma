...
lyenbot_curriculum = CurriculumManagerCfg(
    params={
...
lyenbot_curriculum_fast_sac = CurriculumManagerCfg(
    params={
        "num_compute_average_epl": 1000,
    },
    setup_terms={
        ...
        "domain_rand_curriculum": CurriculumTermCfg(
            ...
            params={
                ...
                "min_scale": 0.05,
                "max_scale": 1.0,
                "level_down_threshold": 650.0,
                "level_up_threshold": 900.0,
                "degree": 0.00025,
                ...
                "dr_push_randomizer_state_max_push_vel_init": [0.1, 0.1],
                "dr_push_randomizer_state_max_push_vel_final": [1., 1.],  # [4.5, 4.5],
...
__all__ = ["lyenbot_curriculum", "lyenbot_curriculum_fast_sac"]

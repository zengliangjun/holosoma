...
lyenbot_loc_fastsac_v1 = ExperimentConfig(
    env_class="holosoma.envs.locomotion.locomotion_manager.LeggedRobotLocomotionManager",
    training=TrainingConfig(project="lyenbot_loc", name="lyenbot_fastsac_v1"),
    ...
    reward=lyenbot_reward.lyenbot_loco_fast_sac_v1,

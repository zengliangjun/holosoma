...
lyenbot_command = CommandManagerCfg(
    ...
    setup_terms={
        ...
        "locomotion_command": CommandTermCfg(
            func="holosoma.managers.command.terms.locomotion_ext:CommandEx",
            params={
                "command_ranges": {
                    "lin_vel_x": [-0.5, 1.0],
                    "lin_vel_y": [-0.5, 0.5],
    ...
    reset_terms={
        ...
        "locomotion_command": CommandTermCfg(func="holosoma.managers.command.terms.locomotion_ext:CommandEx"),
    },
    step_terms={
        "locomotion_gait": CommandTermCfg(func="holosoma.managers.command.terms.locomotion:LocomotionGait"),
        "locomotion_command": CommandTermCfg(func="holosoma.managers.command.terms.locomotion_ext:CommandEx"),
